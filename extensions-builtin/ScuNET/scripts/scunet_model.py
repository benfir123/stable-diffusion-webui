...
def on_ui_settings():
    ...
    shared.opts.add_option("SCUNET_tile", shared.OptionInfo(256, "ขนาดของ Tile สำหรับ SCUNET upscalers.", gr.Slider, {"minimum": 0, "maximum": 512, "step": 16}, section=('upscaling', "Upscaling")).info("0 = ไม่มีการแบ่ง Tile"))
    shared.opts.add_option("SCUNET_tile_overlap", shared.OptionInfo(8, "การทับซ้อนของ Tile สำหรับ SCUNET upscalers.", gr.Slider, {"minimum": 0, "maximum": 64, "step": 1}, section=('upscaling', "Upscaling")).info("ค่าต่ำ = รอยต่อที่มองเห็นได้"))
